...
<div class="px-plugin-wrapper">
	...
	<div class="px-plugin-sidebar">
		...
		<div class="block-section">
            <a href="https://pixolette.com/docs/lscf" target="_blank">
		...
		<div class="block-section">
			<h2>Need Help?</h2>
			<a class="underline" href="https://pixolette.com/docs/lscf">Documentation</a><br/>
			<a class="underline" href="https://pixolette.com/faq">FAQ</a><br/>
		</div>


		<div class="block-section">
			<h2>LSCF PRO</h2>
			<a class="underline" href="https://pixolette.com/wordpress-plugins/lscf-lite-vs-lscf-pro/" target="_blank">LSCF LITE vs LSCF PRO</a><br/>
			<a class="underline" href="https://lscf.pixolette.com/" target="_blank">LSCF PRO Live Demos</a><br/>
			<a class="underline" href="https://pixolette.com/wordpress-plugins/live-search-and-custom-fields" target="_blank">LSCF PRO</a>
		</div>
	...
	<div class="px-left-col">
		...
		<div class="px-lfcf-logo">
			...
			<a class="lscf-pro-banner" href="https://pixolette.com/plugins/live-search-custom-fields-wordpress-plugin/" target="_blank">
